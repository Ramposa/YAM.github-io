...
<html lang="en">
    <head>
    <title>YAM - Database | Home</title>
    <link rel="icon" type="image/png" href="Images/YAMLogo2.png"/>
    <meta charset="utf-8">
    ...
    <div id="Home">
        ...
        $userPass = $_POST['userPass'];  
            ...
            if($count == 1){  
                echo "<pre></pre><h1><center> Login successful </center><br><center><p>Click <a href='mainMenu.html'>here</a> to return to previous page.</p></center></h1><pre></pre>";  
            }  
            else{  
