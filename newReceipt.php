...
<html lang="en">
    <head>
    <title>YAM - Database | New Receipt</title>
...
$IDUser = $_REQUEST["IDUser"]; //get the data from the form
$receiptDate = $_REQUEST["receiptDate"]; 
$receiptItemCount = $_REQUEST['receiptItemCount'];
$receiptNumb = $_REQUEST['receiptNumb'];
$itemSEQ = $_REQUEST['itemSEQ'];
$receiptDesc = $_REQUEST['receiptDesc'];
$receiptAssess = $_REQUEST['receiptAssess'];

//include('conn.php');  
$conn=mysqli_connect('localhost','daniel.tang','J3TA77AK','danieltang_YAMDB');
$sql="INSERT INTO receiptForm (IDUser, receiptDate, receiptItemCount, receiptNumb, itemSEQ, receiptDesc, receiptAssess) 
VALUES ('$IDUser','$receiptDate','$receiptItemCount','$receiptNumb','$itemSEQ','$receiptDesc','$receiptAssess')";
