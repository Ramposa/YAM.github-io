...
<html lang="en">
    <head>
    <title>YAM - Database | Receipt Report</title>
    ...
    <?php
        ...
        {
	        echo "<table>";
	        echo "<tr><th>ID<br></th> <th>Receipt Date Printed</th> <th>Number of Items</th><th>Receipt Number</th> </th> <th>Item SEQ</th> <th>Receipt Description</th> <th>Receipt Assessment</th></tr>";
        }
        while($row = mysqli_fetch_array($rs))
        {
            echo "<center>";
            echo "<tr>";
            echo "<td>" . $row['IDUser'] . "</td><td>" . $row['receiptDate']. "</td><td>" . $row['receiptItemCount']. "</td><td>". $row['receiptNumb'] 
                . "</td><td>" . $row['itemSEQ'] . "</td><td>" . $row['recceiptDesc'] . "</td><td>" . $row['receiptAssess'];
            echo "</tr>";
            echo "</center>";
        }
